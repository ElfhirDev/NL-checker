...
Checker = {
	...
	/*
	* Ask the user to fill the settings
	*
	*/
	...
	*/
	...
	/*
	* Check if there is the good workaround
	* for Outlook vertical spacer
	*/
	...
	/*
	* Check the DTD of the document :
	* Strict is required for Newsletters Responsive
	*
	*/
	...
	/*
	* Check the Display the Metas of the document :
	* You have to know what it is required.
	*
	*/
